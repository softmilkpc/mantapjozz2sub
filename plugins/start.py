...
async def start_command(client: Bot, message: Message):
    ...
    if len(text) > 7:
        ...
        buttons = [
            [InlineKeyboardButton("Join Channel Mantapjozz", callback_data="about")],
            [
            ...
            [
                InlineKeyboardButton("ɢʀᴏᴜᴘ 1", url=client.invitelink5),
                InlineKeyboardButton("ɢʀᴏᴜᴘ 2", url=client.invitelink6),
            ],
            [
                InlineKeyboardButton("Join PPV Group", url=f"https://t.me/PPVarea/5"),
            ],
            [
...
async def get_users(client: Bot, message: Message):
    msg = await client.send_message(
        chat_id=message.chat.id, text="<code>Sabar, Lagi prosess nih ...</code>"
    )
